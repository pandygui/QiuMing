...
`pickname` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '昵称',
`email` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '邮箱',
`telephone` varchar(20) CHARACTER SET utf8 NULL,
`age` int NULL,
...
`role_id` integer NULL COMMENT '用户角色码',
...
`time` datetime NULL COMMENT '关注时间',
PRIMARY KEY (`id`) 
)
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
...
`time` datetime NULL COMMENT '私信时间',
PRIMARY KEY (`id`) 
)
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
...
`car_state` int NOT NULL COMMENT '发车状态。0 未发车，1 发车，2 发车完毕',
PRIMARY KEY (`id`) 
)
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
...
`state` int NOT NULL COMMENT '上车状态,0 还未上车，1乘车，2下车',
PRIMARY KEY (`id`) 
)
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
...
`time` datetime NOT NULL COMMENT '贴标签时间',
PRIMARY KEY (`id`) 
)
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci;
