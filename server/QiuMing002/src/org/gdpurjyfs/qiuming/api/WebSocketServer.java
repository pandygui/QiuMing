...
public class WebSocketServer {
	...
	public void onMessage(String message, Session session) {
		...
		filter.filter( message, userMap.get(session.getId()));
...
//		}
	...
	public static synchronized void addClient(long userId, WebSocketClient client) {
		userMap.put(userId + "", client);
	}
	
	public static synchronized void removeClient(long userId) {
